...
|---|---|
| Managed Devices | 859 |
| Configuration Profiles | 104 |
| Smart Groups | 70+ |
| Migration Timeline | 2 quarters (Q2–Q3 2023) |
| Zero-Touch Enrollment | Whiteglove PreStage via ABM |
| Identity Integration | Jamf Connect + Platform SSO → Microsoft Entra ID |
| Endpoint Protection | Jamf Protect (3 tiered security plans) |
| Network Security | Zscaler (Client Connector + ZTNA) |
| Update Enforcement | Nudge (managed macOS update prompting) |
| Self-Service Apps | Self Service+ catalog (M365, Chrome, Slack, Zoom, and others) |
| Compliance | HITRUST i1 endpoint evidence; CIS Level 1 in progress |
